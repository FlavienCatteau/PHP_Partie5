...
<html lang="fr" dir="ltr">
    <head>
        ...
        <title>Exercice2P5</title>
    </head>
    <body>
        <header>
            <div class="jumbotron text-center">
                <h1 class="display-3 text-center">Exercice 2 partie 5</h1>
                <p class="lead text-center">Avec le tableau de l'exercice 1, afficher la valeur de la troisième ligne de ce tableau.</p>
            </div>
        </header>
        <main>
